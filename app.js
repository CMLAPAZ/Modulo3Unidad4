...
app.post('/ingresar', function(req, res){
  ...
  app.use(function(req, res, next) {
    //si no existe la variable de session vistas la 
    //cramos como un objeto vacio
    if (!req.session.vistas) {
      req.session.vistas = {};
    }
    // buscamos una clave dentro session.vistas que coincida
  ...
  app.get('/nosotros', function(req, res){
    /** 
     * pasamos al temple la variable cistas con el 
